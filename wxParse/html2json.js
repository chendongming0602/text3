...
e("wxxxcode-style,script,style,view,scroll-view,block,open-data");
    ...
    html2json: function(e, n) {
        ...
        return d(e, {
            start: function(e, t, r) {
                ...
                a.index = x.index + "." + x.nodes.length), c[e] ? a.tagType = "block" : p[e] ? a.tagType = "inline" : u[e] && (a.tagType = "closeSelf"), 
